...
class Dangnhap extends CI_Controller {
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'huathaihungad@gmail.com';
            $config['smtp_pass']    = 'lulgedennbjqfndx';
            ...
            $this->email->from('huathaihungad@gmail.com', 'Organica-ADMIN');
            $this->email->to($email);
            $this->email->subject('Organica - Quà dành cho thành viên mới <3');
            $this->email->message('Chào mừng bạn đã trở thành thành viên mới của cửa hàng Organica chúng tôi, Cửa hàng sẽ tặng bạn 1 mã giảm giá có giá trị 100.000 đ: '.$tempcoupon.' , Mã này có hạn dùng đến ngày '.$tempdatelimit.'
                Hãy sử dụng tài khoản thành viên để mua hàng để tích lũy nhận thêm nhiều ưu đãi hấp dẫn nhé!!!');
            $this->email->send();
